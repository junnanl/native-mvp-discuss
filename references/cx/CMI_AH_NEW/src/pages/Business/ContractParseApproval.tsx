...
// 主页面
// ============================================================
interface ContractParseApprovalProps {
...
export default function ContractParseApproval({ onNavigate, contractId, readOnly = false, parseType = 'forward' }: ContractParseApprovalProps) {
      ...
      <div className="w-full min-w-0 mx-auto p-3 space-y-3">
        ...
        <div className="bg-white rounded-lg shadow-sm px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-800">{readOnly ? '合同详情' : parseType === 'backward' ? '后向合同解析' : '前向合同解析审批'}</h2>
          </div>
        </div>
        ...
        {/* 流程信息（仅审批驳回时展示） */}
        {!readOnly && approvalResult === 'rejected' && (
          <div className="bg-white rounded-lg shadow-sm">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100">
              <div className="w-1 h-4 bg-[#1677FF] rounded-sm" />
