...
interface IncomeExpenseContractDetailProps {
  onNavigate?: (path: string) => void
  contractId?: string
}

// ============================================================
// 收入 / 成本计划 mock 数据（复制自有收有支合同解析审批页面，独立维护）
// ============================================================
...
const mockCostPlans = [
  {
    ...
    coaSubject: 'C-1372-01',
    paymentPlans: [
      { id: 'cost-pp-1', milestone: '项目开工', amount: '50,000', paymentDate: '2026-03', transferDate: '2026-03' },
      { id: 'cost-pp-2', milestone: '项目上线', amount: '50,000', paymentDate: '2026-06', transferDate: '2026-06' },
      { id: 'cost-pp-3', milestone: '终验', amount: '50,000', paymentDate: '2026-12', transferDate: '2026-12' }
    ]
  },
  {
    id: 'iepa-cost-2',
    ...
    coaSubject: 'C-849-01',
    paymentPlans: [
      { id: 'cost-pp-4', milestone: '项目开工', amount: '30,000', paymentDate: '2026-03', transferDate: '2026-03' },
      { id: 'cost-pp-5', milestone: '项目上线', amount: '70,000', paymentDate: '2026-06', transferDate: '2026-06' }
    ]
  },
  {
    id: 'iepa-cost-3',
    ...
    coaSubject: 'C-956-01',
    paymentPlans: [
      { id: 'cost-pp-6', milestone: '到货', amount: '80,000', paymentDate: '2026-03', transferDate: '2026-03' }
    ]
  }
]
...
const mockProcessTrail = [
  { time: '2026-06-02 09:30', actor: '李明', action: '起草合同' },
  { time: '2026-06-18 15:20', actor: '王芳', action: '合同审核通过' },
  { time: '2026-06-20 09:00', actor: '系统', action: '合同生效，开始履行' }
]

// ============================================================
// 主页面
// ============================================================
export default function IncomeExpenseContractDetail({ onNavigate, contractId }: IncomeExpenseContractDetailProps) {
  ...
  return (
    <div className="h-full overflow-auto bg-gray-50">
      <div className="w-full min-w-0 mx-auto p-3 space-y-3">
        ...
        <div className="bg-white rounded-lg shadow-sm px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-800">有收有支合同详情</h2>
          </div>
        </div>
      ...
      {incomePaymentPlanModal.visible && incomePaymentPlanModal.row && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setIncomePaymentPlanModal({ visible: false, row: null })}>
          <div
            className="bg-white rounded-lg shadow-xl w-[800px] max-w-[92vw] max-h-[70vh] overflow-hidden"
      ...
      {costPaymentPlanModal.visible && costPaymentPlanModal.row && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setCostPaymentPlanModal({ visible: false, row: null })}>
          <div
            className="bg-white rounded-lg shadow-xl w-[800px] max-w-[92vw] max-h-[70vh] overflow-hidden"
            onClick={e => e.stopPropagation()}
          >
