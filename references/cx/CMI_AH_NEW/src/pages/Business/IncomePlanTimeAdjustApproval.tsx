...
import { parseCtProductName } from '@/components/plan-modules/constants'
...
interface IncomePlanTimeAdjustApprovalProps {
...
const newITIncome: ITIncomeRow[] = [
  ...
  },
  {
    ...
    billingSharePeriod: '1',
    isContractAsset: '是',
    plannedOrderDate: '2026-10-01',
    billingStartDate: '2026-10'
  },
  {
    id: 'it-new-3',
    productName: '平台使用费',
    ...
    billingSharePeriod: '1',
    isContractAsset: '否',
    plannedOrderDate: '2026-11-01',
    billingStartDate: '2026-11'
  }
]
...
export default function IncomePlanTimeAdjustApproval({ onNavigate, contractId }: IncomePlanTimeAdjustApprovalProps) {
    ...
    modal.confirm('确定提交吗？', '提交').then(ok => {
      if (ok) {
        ...
        if (approvalResult === 'rejected') {
          onNavigate?.(`/finance/contract/income-plan-time-adjust-init/${contractId || 'CT2026060001'}`)
        } else {
      ...
      <div className="w-full min-w-0 mx-auto p-3 space-y-3">
        <div className="bg-white rounded-lg shadow-sm px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-800">收入计划时间调整审批</h2>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="px-3 py-2 text-sm text-gray-700 leading-relaxed">
                  因客户业务需求调整，原合同中IT收入计划及CT收入计划的计费开始时间需进行变更。其中IT收入计划维保费的计费开始时间由2026-08-01调整为2026-09-01，设备费由2026-07-15调整为2026-08-15；CT收入计划专线产品的计费开始时间由2026-08-01调整为2026-09-01，宽带产品由2026-07-01调整为2026-08-01。变更后各产品计费周期顺延一个月，已附相关证明材料，请审批。
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center px-3 py-2 bg-white border border-gray-200 rounded-md">
                    ...
                    <div className="flex items-center flex-1 min-w-0 ml-3">
                      <span className="text-sm text-gray-800 truncate">收入计划时间调整申请说明.pdf</span>
                      <span className="inline-flex items-center px-1.5 py-0.5 text-xs text-gray-600 bg-gray-100 rounded shrink-0 ml-3">证明材料</span>
                    </div>
                    <span className="text-xs text-gray-400 shrink-0 ml-2">256KB</span>
                    <span className="text-xs text-gray-400 shrink-0 ml-2">2026-07-20</span>
                  ...
                  <div className="flex items-center px-3 py-2 bg-white border border-gray-200 rounded-md">
                    <FileText className="w-4 h-4 text-[#1677FF] shrink-0" />
                    <div className="flex items-center flex-1 min-w-0 ml-3">
                      <span className="text-sm text-gray-800 truncate">客户业务调整确认函.pdf</span>
                      <span className="inline-flex items-center px-1.5 py-0.5 text-xs text-gray-600 bg-gray-100 rounded shrink-0 ml-3">证明材料</span>
                    </div>
                    <span className="text-xs text-gray-400 shrink-0 ml-2">180KB</span>
                    <span className="text-xs text-gray-400 shrink-0 ml-2">2026-07-20</span>
                    <button type="button" className="inline-flex items-center gap-1 text-xs text-[#1677FF] hover:text-blue-700 shrink-0 ml-2">
                      <Eye className="w-3.5 h-3.5" />预览
                    </button>
