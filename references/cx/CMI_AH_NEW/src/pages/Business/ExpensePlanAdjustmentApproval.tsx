...
interface ExpensePlanAdjustmentApprovalProps {
...
// 支出计划调整审批 - 独立 mock 数据（与后向合同解析审批页面互不影响）
const mockCostPlans = [
  {
    id: 'cost-adj-1',
    productName: '集成费',
...
export default function ExpensePlanAdjustmentApproval({
  onNavigate,
  contractId
}: ExpensePlanAdjustmentApprovalProps) {
  const contractInfo = getContractInfo(contractId || 'CT2026060004')
      ...
      <div className="w-full mx-auto p-3 space-y-3">
        ...
        <div className="bg-white rounded-lg shadow-sm px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-800">支出计划调整审批</h2>
          </div>
