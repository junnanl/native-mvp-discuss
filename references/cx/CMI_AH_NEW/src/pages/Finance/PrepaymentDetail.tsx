...
import { ArrowLeft, RotateCcw, ChevronDown, ChevronRight, X } from 'lucide-react'

interface PrepaymentDetailProps {
...
// 主页面
// ============================================================
export default function PrepaymentDetail({ onNavigate, id }: PrepaymentDetailProps) {
      ...
      <div className="w-full min-w-0 mx-auto p-3 space-y-3">
        ...
        <div className="bg-white rounded-lg shadow-sm px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-800">预付款详情</h2>
          </div>
        </div>
