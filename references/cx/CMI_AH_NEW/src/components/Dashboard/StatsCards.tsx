...
const metricGroups: MetricGroup[] = [
  {
    ...
    subMetrics: [
      { label: '方案响应及时率', value: '92.3%', color: 'text-cyan-600' },
      { label: '处理中数量', value: '24 个', color: 'text-orange-600' },
      { label: '本月完成数量', value: '12 个', color: 'text-green-600' }
    ]
  },
  {
    id: 'bidSupport',
    ...
    subMetrics: [
      { label: '中标率', value: '35.6%', color: 'text-red-600' },
      { label: '处理中数量', value: '18 个', color: 'text-orange-600' },
      { label: '本月完成数量', value: '9 个', color: 'text-green-600' }
    ]
  },
  {
    id: 'selectionSupport',
    ...
    subMetrics: [
      { label: '甄选响应及时率', value: '85.4%', color: 'text-cyan-600' },
      { label: '处理中数量', value: '12 个', color: 'text-orange-600' },
      { label: '本月完成数量', value: '7 个', color: 'text-green-600' }
    ]
  }
]
              ...
              <div>
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-2xl font-bold text-gray-800 leading-none">
                    {group.mainValue.toLocaleString()}
                  </span>
