...
const STATE_DIR = process.env.SSH_MANAGER_HOME || path.join(os.homedir(), '.ssh-manager');
const HOOKS_CONFIG_FILE = path.join(STATE_DIR, 'hooks-config.json');
const HOOKS_DIR = path.join(STATE_DIR, 'hooks');
