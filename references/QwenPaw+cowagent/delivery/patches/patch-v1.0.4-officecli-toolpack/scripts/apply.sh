...
main() {
  ...
  backup_tree "${TARGET_ROOT}/toolpacks/binaries/officecli" "${backup_dir}" "toolpack"
  backup_tree "${TARGET_ROOT}/storage/cow/skills/officecli" "${backup_dir}" "skill"
  backup_tree "${TARGET_ROOT}/storage/cow/skills/skills_config.json" "${backup_dir}" "skills-config"

  copy_tree "${PATCH_ROOT}/patches/toolpacks/binaries/officecli" \
    "${TARGET_ROOT}/toolpacks/binaries/officecli"
  copy_tree "${PATCH_ROOT}/patches/skills/officecli" \
    "${TARGET_ROOT}/storage/cow/skills/officecli"
  chmod a+rx "${TARGET_ROOT}/toolpacks/binaries/officecli/officecli"
  ...
  info "OfficeCLI Toolpack update applied"
}
