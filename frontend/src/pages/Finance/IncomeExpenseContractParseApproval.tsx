...
interface IncomeExpenseContractParseApprovalProps {
...
export default function IncomeExpenseContractParseApproval({
  onNavigate,
  contractId
}: IncomeExpenseContractParseApprovalProps) {
      ...
      <div className="w-full mx-auto p-3 space-y-3">
        ...
        <div className="bg-white rounded-lg shadow-sm px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-semibold text-gray-800">有收有支合同解析审批</h2>
          </div>
